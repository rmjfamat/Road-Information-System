...
<html>
  ...
  <body>
    ...
    <script>
      ...
      */
      ...
      function getTimestamp(addClick) {
        ...
        var ref = rootRef.child('last_message/' + data.sender);
      ...
      function addToFirebase(data) {
        getTimestamp(function(timestamp) {
          ...
          var ref = rootRef.child('clicks').push(data, function(err) {
    ...
    <script async defer
        src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDGKa5UD5RrSnbKy-aathS0BhlZK-T3UPI&callback=myMap&libraries=visualization&callback=initMap">
    </script>
  </body>
</html>